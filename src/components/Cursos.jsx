...
const Cursos = () => {
  return (
    <div className="bg-section-reverse">
      <div className="container px-5 pt-32 mx-auto lg:px-4 lg:py-4 mt-20" data-aos="fade-up">
        <div className="mx-auto sm:text-center lg:max-w-2xl">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-center text-gray-300 sm:text-4xl md:mx-auto">
              Transformá tu pasión por la música en una carrera profesional
            </h2>
            <p className="text-gray-400 text-lg">
              Potencia al máximo tus habilidades de producción de música con nuestros cursos de formación en producción musical, mezcla y mastering. Aprendé de experimentados profesionales del sector y desarrollá las técnicas y conocimientos necesarios para crear y producir tu música como un verdadero profesional. ¡Unite a nuestros cursos ahora y comienza tu camino hacia una exitosa carrera en la industria musical!
            </p>
          </div>
