        ...
        <div className="grid gap-10 pt-10 lg:grid-cols-2">
          <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
            ...
            <div className="bg-gradient-to-r from-[#1f0019] to-transparent bg-opacity-50 rounded-lg px-4 py-6 mx-auto sm:px-8 sm:py-8 md:px-10 md:py-8 lg:max-w-xl lg:px-12 lg:py-10">
              <div className="flex items-center mb-6 justify-right sm:justify-start">
              ...
              <div className="mt-14">
                <audio controls controlsList="nodownload" preload="auto" src={Publi} className="w-full"/>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center">
            <img src={AboutImg} alt="" className="w-[550px] rounded-2xl"/>
          </div>
        </div>
      </div>
      <div>
