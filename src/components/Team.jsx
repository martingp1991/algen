...
import Horacio from "../assets/team/Horacio.jpeg";
import Pipo from "../assets/team/Pipo.jpeg";
...
const Team = () => {
  ...
  return (
    <div className='bg-section-reverse'>
      <div className="relative w-full py-10 mx-auto text-gray-700 max-w-7xl mt-14">
        ...
        <div className="grid w-full max-w-5xl grid-cols-2 px-4 mx-auto gap-y-4 sm:gap-y-10">
          <div className="flex flex-col items-center justify-center col-span-full lg:col-span-1 sm:flex-row" data-aos="fade-up">
          ...
          <div className="flex flex-col justify-center max-w-lg mx-auto space-y-4 col-span-full lg:col-span-1 lg:mx-0" data-aos="fade-up">
            <span className="font-bold tracking-wider text-gray-300 uppercase" data-aos="fade-up">{people[member].role}</span>
            <h3 className="space-y-2 text-4xl font-bold sm:text-5xl" data-aos="fade-up">
